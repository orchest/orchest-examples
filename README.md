...
- [](https://github.com/ricklamers/orchest-coiled-cluster-xgboost) -<!--o--> Spin up a Coiled cluster and run an xgboost train loop on it. Separate Coiled cluster creation step to make it re-usable. <!--o-->- `dask` `coiled` `xgboost` `machine-learning`
